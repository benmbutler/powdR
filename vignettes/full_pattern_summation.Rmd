...
resulting in a computation time of less than one second. Whilst the use of NNLS is fast, there is a small compromise in accuracy compared to the minimisation of an objective function (see Supplementary Material in @Butler2021powdR).
...
#Create a new grouping structure for those IDs
rg_name <- c("Non-clay", #CORUNDUM
             "Non-clay", #QUARTZ
             "Non-clay", #ORDERED_MICROCLINE
             "Non-clay", #ORTHOCLASE
             "Non-clay", #ALBITE_CLEAVELANDITE
             "Non-clay", #ANDESINE
             "Non-clay", #LABRADORITE
             "Non-clay", #ANORTHITE
              "Clay", #ORD_KAOLINITE
              "Clay" #CA_MONTMORILLONITE
              )

#Create a data frame from that structure
rg_str <- data.frame("phase_id" = rg_id,
                     "phase_name" = rg_name)

#Regroup the data in a_fit1
a_fit1_rg <- regroup(a_fit1, rg_str)
...
More help on the **powdR** Shiny app can be found in [this video tutorial](https://www.youtube.com/watch?v=dDd6cr8kpTc&feature=emb_title).
